...
model = acanalysisForVar(elements,nodes,frequencies,amountOfMeasurements, amountOfMeasurementLocations, measurementMatrix,phaseMatrix, observedNodeIndices)
using Optim
map_estimate = optimize(model,MAP())

print(names(map_estimate.values))
